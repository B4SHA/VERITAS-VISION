...
const VideoIntegrityOutputSchema = z.object({
    ...
    analysis: z.object({
        ...
        satireOrParody: z.boolean().describe("True if the video's context is likely satirical or parody. False otherwise."),
        misleadingContext: z.boolean().describe("True if the video is used in a misleading context (e.g., old footage presented as new). False otherwise.")
    }),
});
...
4.  **Contextual Analysis**: Determine if the content could be satirical, a parody, or used in a misleading context based on its content.
