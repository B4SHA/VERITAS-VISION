...
3.  **Contextual Analysis (Web Search)**: You MUST use the provided Google Search tool to perform a conceptual reverse image search. Determine the likely origin and context of the image. Is it being used out of context to spread misinformation? Find news articles, fact-checks, or other sources discussing the image.
