...
const ImageVerifierOutputSchema = z.object({
    ...
    context: z.string().describe("An explanation of the image's potential context, including reverse image search findings or relevant news."),
...
const prompt = ai.definePrompt({
    ...
    prompt: `You are an expert digital image forensics analyst. Your task is to analyze an image to determine its authenticity and detect any signs of AI generation, digital manipulation, or misleading context.
...
3.  **Contextual Analysis**: Perform a conceptual reverse image search. Determine the likely origin and context of the image. Is it being used out of context to spread misinformation?
...
6.  **Reporting**: Generate a comprehensive report detailing your findings, including the forensic methods used and the reasoning for your verdict.
